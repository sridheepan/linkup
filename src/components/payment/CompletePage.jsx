...
const CompletePage = () => {
  return (
    <div
      id='payment-status'
      className='flex flex-col justify-center items-center gap-8 w-[30vw] min-w-[500px] min-h-[380px] self-center rounded-lg shadow-lg p-10 opacity-0 animate-fadeIn'>
      <div
        id='status-icon'
      ...
      <a
        id='retry-button'
        href='/'
        className='text-center bg-[#0055DE] text-white font-semibold py-3 px-4 rounded-lg'>
        Test another
      </a>
    </div>
  );
